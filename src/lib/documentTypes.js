...
export const DOCUMENT_TYPES = {
  ...
  projectReport: {
    ...
    description: 'Post-operation deliverable report',
    icon: BarChart,
    category: 'client',
    color: 'cyan',
    aiEnhancement: {
      executiveSummary: 'Summary of completed work',
      findingsNarrative: 'Description of key findings',
    ...
    sections: [
      ...
      { id: 'methodology', label: 'Methodology Used', required: false, default: true },
      { id: 'findings', label: 'Findings & Results', required: true, default: true },
      { id: 'data', label: 'Data Summary', required: false, default: true },
