...
function getPolicyContent(policyNumber) {
  return POLICY_CONTENT[policyNumber] || null
}

// Export list of available policy numbers
function getAvailablePolicyNumbers() {
  return Object.keys(POLICY_CONTENT)
}

// default export: POLICY_CONTENT

module.exports = { POLICY_CONTENT, getPolicyContent, getAvailablePolicyNumbers };
